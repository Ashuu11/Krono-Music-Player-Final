      ...
      <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
        ...
        <div className="hidden xl:inline max-w-[270px]">
          ...
          <div className="genre">Classic</div>
            ...
            <div className="genre">Bollywood</div>
            <div className="genre">Lo-Fi</div>
            <div className="genre">Pop</div>
            <div className="genre">Chillout</div>
            <div className="genre">Punjabi</div>
            <div className="genre">Regional</div>
            <div className="genre">Folks and Acoustic</div>
            </div>
